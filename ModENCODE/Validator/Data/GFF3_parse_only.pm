package ModENCODE::Validator::Data::GFF3_parse_only;
=pod
...
sub validate {
  ...
  log_error "Validating attached GFF3 file(s) (but not loading features into Chado).", "notice", ">";
