...
#    }
    ...
    $fa_file =  $fasta_path . "dana.r1.3.dna.fa.fai" if ($fa_organism eq "Drosophila ananassae");
    $fa_file =  $fasta_path . "dvir.r1.2.dna.fa.fai" if ($fa_organism eq "Drosophila virilis");
    $fa_file =  $fasta_path . "dyak.r1.3.dna.fa.fai" if ($fa_organism eq "Drosophila yakuba");
